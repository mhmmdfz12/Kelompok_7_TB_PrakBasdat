...
if (!$conn) {
    die("Koneksi database gagal di index.php (dosen): " . mysqli_connect_error());
}

// Jalankan query untuk mengambil semua data dari tabel dosen
// Pastikan nama kolom di database Anda sama persis dengan yang digunakan di sini
$sql = "SELECT nip, nama_dosen, email FROM dosen";
$result = mysqli_query($conn, $sql);

// Periksa apakah query berhasil dijalankan
if (!$result) {
    die("Query SELECT gagal: " . mysqli_error($conn) . "<br>Pastikan tabel 'dosen' sudah ada dan nama kolom sudah benar.");
}
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="edit.php?nip=<?= htmlspecialchars($row['nip'] ?? '') ?>" class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <a href="delete.php?nip=<?= htmlspecialchars($row['nip'] ?? '') ?>" class="btn btn-danger btn-sm" onclick="return confirm('Hapus data ini?')">
                    ...
                    <?php
                        ...
                        echo "<tr><td colspan='4' class='text-center py-4'>Tidak ada data dosen.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>

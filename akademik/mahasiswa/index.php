...
if (!$conn) {
    die("Koneksi database gagal di index.php: " . mysqli_connect_error());
}

// Jalankan query untuk mengambil semua data dari tabel mahasiswa
$sql = "SELECT nim, nama, alamat, tanggal_lahir FROM mahasiswa"; // Lebih spesifik dalam memilih kolom
$result = mysqli_query($conn, $sql);

// Periksa apakah query berhasil dijalankan
if (!$result) {
    die("Query SELECT gagal: " . mysqli_error($conn) . "<br>Pastikan tabel 'mahasiswa' sudah ada dan nama kolom sudah benar.");
}
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="edit.php?nim=<?= htmlspecialchars($row['nim'] ?? '') ?>" class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <a href="delete.php?nim=<?= htmlspecialchars($row['nim'] ?? '') ?>" class="btn btn-danger btn-sm" onclick="return confirm('Hapus data ini?')">
                    ...
                    <?php
                        ...
                        echo "<tr><td colspan='5' class='text-center py-4'>Tidak ada data mahasiswa.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
